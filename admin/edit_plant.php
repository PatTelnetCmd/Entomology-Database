...
<?php
        ...
        $plant_image = $db->select_one("SELECT image_url FROM images WHERE plant_ID = {$id} LIMIT 1");
      ...
      if(isset($_POST['submit'])) {
            ...
            if(count($_FILES['images']['name']) > 0 && !empty($_FILES['images']['name'][0])) {
                  ...
                  //*===Updating plant table=========*
                  $message = '';
                  $sql_update  = "UPDATE plants SET family_ID = {$db->escape_string($family)}, genus_ID = {$db->escape_string($genus)}, species_ID = {$db->escape_string($species)},
                                                            locality = '{$db->escape_string($locality)}', habitat = '{$db->escape_string($habitat)}', region = '{$db->escape_string($region)}', ";
                  $sql_update .= "gps_nothings = '{$db->escape_string($gps_north)}', gps_eastings = '{$db->escape_string($gps_east)}', image = '{$image}', description = '{$db->escape_string($description)}', ";
                  $sql_update .= "date_of_collection = '{$db->escape_string($date)}'";
                  
                  $sql_update .= " WHERE plant_ID = {$id}";
                  $run_query = $db->update($sql_update);
                  ...
                  for($i = 0; $i < count($_FILES['images']['name']); $i++) {
                      ...
                      if($tempFilePath != "") {
                          ...
                          if(move_uploaded_file($tempFilePath, $filePath)) {
                              ...
                              //checking if an entery with id exist
                              $check_entry = $db->select("SELECT * FROM images WHERE plant_ID = {$last_id}");
                              if($check_entry){
                                  //*===========Deleting entry========================*
                                  $delete_entry = $db->delete("DELETE FROM images WHERE plant_ID = {$last_id}");
                              }
                  ...
                  $sql_update  = "UPDATE plants SET family_ID = {$db->escape_string($family)}, genus_ID = {$db->escape_string($genus)}, species_ID = {$db->escape_string($species)},
                                                            locality = '{$db->escape_string($locality)}', habitat = '{$db->escape_string($habitat)}', region = '{$db->escape_string($region)}', ";
                  $sql_update .= "gps_nothings = '{$db->escape_string($gps_north)}', gps_eastings = '{$db->escape_string($gps_east)}', description = '{$db->escape_string($description)}', ";
                  $sql_update .= "date_of_collection = '{$db->escape_string($date)}' ";
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Edit Plant Record</li>
                              ...
                              <div class="panel-body">
                                    <form class="form-horizontal" action="" method="post" enctype="multipart/form-data" novalidate>
                                          <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                      <select id="family" name="family" class="form-control">
                                                            <option selected value="<?php echo $plant_record->family_ID; ?>"><?php echo $plant_record->family_name; ?></option>
                                          ...
                                          <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                      <select id="genus" name="genus" class="form-control">
                                                            <option selected value="<?php echo $plant_record->genus_ID; ?>"><?php echo $plant_record->genus_name; ?></option>
                                          ...
                                          <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                      <select id="species" name="species" class="form-control">
                                                            <option selected value="<?php echo $plant_record->species_ID; ?>"><?php echo $plant_record->species_name; ?></option>
                                          ...
                                          <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                      <input type="text" id="locality" name="locality" class="form-control" value="<?php echo $plant_record->locality; ?>">
                                                </div>
                                          </div>
                                          ...
                                          <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                      <input type="text" id="habitat" name="habitat" class="form-control" value="<?php echo $plant_record->habitat; ?>">
                                                </div>
                                          </div>
                                          ...
                                          <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                      <input type="text" id="gps_east" name="gps_east" class="form-control" value="<?php echo $plant_record->gps_eastings; ?>">
                                                </div>
                                          </div>
                                          ...
                                          <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                      <input type="text" id="gps_north" name="gps_north" class="form-control" value="<?php echo $plant_record->gps_nothings; ?>">
                                                </div>
                                          </div>
                                           ...
                                           <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input id="dp1" type="text" size="16" class="form-control" name="date" value="<?php echo $plant_record->date_of_collection; ?>">
                                                </div>
                                           </div>
                                          ...
                                          <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                      <input type="text" id="region" name="region" class="form-control" value="<?php echo $plant_record->region; ?>">
                                                </div>
                                          </div>
                                          ...
                                          <div class="form-group">
                                                <?php if($plant_image): ?>
                                                        <div class="col-md-offset-2"><img src="<?php echo $plant_image->image_url; ?>" alt="" width="100px"></div>
                                                <?php else: ?>
                                                        <div class="alert alert-warning col-md-8 col-md-offset-2">No image yet!</div>
                                                <?php endif; ?> 
                                          </div>
                                          ...
                                          <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                      <textarea id="description" name="description" class="form-control" rows="10">
                                                       <?php echo $plant_record->description; ?> 
                                                      </textarea>
                                                </div>
                                          </div>
